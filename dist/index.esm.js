...
var LogoImage = styled.div(templateObject_1$x || (templateObject_1$x = __makeTemplateObject(["\n  margin-left: 24px;\n"], ["\n  margin-left: 24px;\n"])));
var Logo = function (_a) {
    _a.isDark; __rest(_a, ["isDark"]);
    return (React.createElement(LogoImage, null,
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss },
        ...
        React.createElement(Flex, { mb: "32px" },
            React.createElement(LinkExternal, { small: true, href: "https://cchain.explorer.avax.network/" + account, mr: "16px" }, "View on Explorer"),
...
var Avatar = function (_a) {
    ...
    var icon = image ? (React.createElement("img", { src: image, alt: "profile avatar", height: "32px", width: "32px" })) : (React.createElement(Icon$1b, { width: "32px", height: "32px" }));
    if (isExternal) {
...
var Menu = function (_a) {
    ...
    var chartEx = "https://knights-fantom.gitbook.io/knights-of-fantom/";
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu },
            React.createElement(DLInfoContainer, null,
                ...
                React.createElement("div", { className: "badges" },
                    React.createElement(InfoBoxes, null,
                        React.createElement(Link, { href: "/farms", target: "_blank" },
                            React.createElement("img", { className: "navImg tinyDragons", src: "/images/egg/logo3.png", alt: "FARMS" }))),
                    React.createElement(InfoBoxes, null,
                        React.createElement(Link, { href: "/pools", target: "_blank" },
                            React.createElement("img", { className: "navImg tinyDragons", src: "/images/egg/logo4.png", alt: "POOLS" }))),
                    React.createElement(InfoBoxes, null,
                        React.createElement(Link, { href: "/", target: "_blank" },
                            React.createElement("img", { className: "navImg tinyDragons", src: "/images/egg/logo2.png", alt: "Tiny Dragons!" }))))),
        ...
        React.createElement(MenuWrapper, null,
            React.createElement(StyledLinkTag, { href: "https://discord.com/invite/UQSZD86HNG", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
                    React.createElement("img", { className: "menu-pic", alt: "discord", src: "https://apksshare.com/wp-content/uploads/2021/06/Discord-Talk-Video-Chat-Hang-Out-with-Friends-APK-MOD-Download-77.6-Stable.png" }),
                    " ",
                    React.createElement("span", { className: "menu-text" }, "DISCORD"))),
            React.createElement(StyledLinkTag, { href: "https://t.me/knightsofFTM", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
                    React.createElement("img", { className: "menu-pic", alt: "telegram", src: "https://image.flaticon.com/icons/png/512/124/124019.png" }),
                    " ",
                    React.createElement("span", { className: "menu-text" }, "TELEGRAM"))),
            React.createElement(StyledLinkTag, { href: "https://twitter.com/knightsoffantom", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
                    React.createElement("img", { className: "menu-pic", alt: "twitter", src: "https://seeklogo.com/images/T/twitter-icon-square-logo-108D17D373-seeklogo.com.png" }),
                    " ",
                    React.createElement("span", { className: "menu-text" }, "TWITTER"))),
            React.createElement(StyledLinkTag, { href: "https://knights-fantom.gitbook.io/knights-of-fantom/", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
            ...
            React.createElement(StyledLinkTag, { href: "/", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
            ...
            React.createElement(StyledLinkTag, { href: "/", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
                    React.createElement("img", { className: "menu-pic", alt: "exchange", src: "/images/egg/tjoe.png" }),
                    React.createElement("span", { className: "menu-text" }, "EXCHANGE"))),
            React.createElement(StyledLinkTag, { href: "/", target: "_blank" },
                React.createElement("div", { className: "menu-icons" },
                    React.createElement("img", { className: "menu-pic", alt: "vfat", src: "/images/menu/vfaticon.jpg" }),
                    React.createElement("span", { className: "menu-text" }, "VFAT"))))));
};
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#fff", textDisabled: "#BDC2C4", textSubtle: "#efcd52", borderColor: "#E9EAEB", card: "rgba(0,0,0,0.75)", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { secondary: "#da3b2e", background: "#343135", backgroundDisabled: "#3c3742", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#483f5a", primaryDark: "#0098A1", tertiary: "#353547", text: "#ffb341", textDisabled: "#666171", textSubtle: "#c9c4d4", borderColor: "#524B63", card: "#2c240e66", gradients: {
